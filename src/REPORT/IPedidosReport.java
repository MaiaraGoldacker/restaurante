...
public class IPedidosReport {
    ...
    public void gerarRelatorioLucro(String idPagamento, int idUsuario, String edIni, String edFim) throws JRException, SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException, ParseException {
        ...
        edIni = Utilidades.getInstance().formataDataFiltro(edIni, true);
        edFim = Utilidades.getInstance().formataDataFiltro(edFim, true); 
        ...
        try {
            ...
            JasperPrint impressao = JasperFillManager.fillReport(relat, parametros, Utilidades.getInstance().pegaConexaoBD());
      ...
      public void gerarRelatorioPadrao(String caminho, String titulo) throws SQLException {
        try{
            JasperPrint impressao = JasperFillManager.fillReport(caminho, null, Utilidades.getInstance().pegaConexaoBD());
            JasperViewer viewer = new JasperViewer(impressao, false);

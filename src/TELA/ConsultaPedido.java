...
public class ConsultaPedido extends javax.swing.JFrame {
    ...
    private void carregaDetalhesTela() {
        ...
        btatu.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/baix.png")));
        btatu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/baix.png")));
        btatu2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/baix.png")));
        btatu3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/baix.png")));
        btatu4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/baix.png")));
        btatu5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/baix.png")));
        btAtualizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/carr.png")));
        this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/imagens/consped.png")).getImage());
        ...
        try {
            ...
            for (Pedido ped : lista) {
                ...
                for (Pedido pedCom : listaComanda) {
                    ...
                    desc += RegrasPedido.getInstance().carregaPedidosRealizados(pedCom);
    ...
    private void initComponents() {
        ...
        lbNrPedido6 = new javax.swing.JLabel();
        ...
        lbNrPedido7 = new javax.swing.JLabel();
        ...
        lbNrPedido8 = new javax.swing.JLabel();
        lbtempo2 = new javax.swing.JLabel();
        jPanel4 = new javax.swing.JPanel();
        btatu4 = new javax.swing.JButton();
        lbNrPedido11 = new javax.swing.JLabel();
        ...
        lbNrPedido9 = new javax.swing.JLabel();
        ...
        lbNrPedido10 = new javax.swing.JLabel();
        ...
        lbNrPedido.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        lbNrPedido6.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido6.setText("Comanda");
        ...
        lbNrPedido1.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido1.setText("jLabel1");

        lbNrPedido7.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido7.setText("Comanda");
        ...
        lbNrPedido2.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido2.setText("jLabel1");

        lbNrPedido8.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido8.setText("Comanda");
        ...
        lbNrPedido11.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido11.setText("Comanda");
        ...
        lbNrPedido3.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        lbNrPedido9.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido9.setText("Comanda");
        ...
        lbNrPedido4.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        ...
        lbNrPedido5.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido5.setText("jLabel1");

        lbNrPedido10.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        lbNrPedido10.setText("Comanda");
    ...
    private void btatuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btatuActionPerformed
        try {
            RegrasPedido.getInstance().alteraStatusPedidos(PedidoDAO.getInstance().findAllAtender(1,Integer.parseInt(lbNrPedido.getText())));
            limpaTela();
            carregaTelaPedidos();
    ...
    private void btatu1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btatu1ActionPerformed
        try {
            RegrasPedido.getInstance().alteraStatusPedidos(PedidoDAO.getInstance().findAllAtender(1,Integer.parseInt(lbNrPedido1.getText())));
            limpaTela();
            carregaTelaPedidos();
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaPedido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btatu2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btatu2ActionPerformed
        try {
            RegrasPedido.getInstance().alteraStatusPedidos(PedidoDAO.getInstance().findAllAtender(1,Integer.parseInt(lbNrPedido2.getText())));
            limpaTela();
            carregaTelaPedidos();
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaPedido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btatu3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btatu3ActionPerformed
        try {
            RegrasPedido.getInstance().alteraStatusPedidos(PedidoDAO.getInstance().findAllAtender(1, Integer.parseInt(lbNrPedido3.getText())));
            limpaTela();
            carregaTelaPedidos();
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaPedido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btatu4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btatu4ActionPerformed
        try {
            RegrasPedido.getInstance().alteraStatusPedidos(PedidoDAO.getInstance().findAllAtender(1,Integer.parseInt(lbNrPedido4.getText())));
            limpaTela();
            carregaTelaPedidos();
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaPedido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void btatu5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btatu5ActionPerformed
        try {
            RegrasPedido.getInstance().alteraStatusPedidos(PedidoDAO.getInstance().findAllAtender(1,Integer.parseInt(lbNrPedido5.getText())));
            limpaTela();
            carregaTelaPedidos();
        } catch (SQLException ex) {
            Logger.getLogger(ConsultaPedido.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel lbNrPedido10;
    private javax.swing.JLabel lbNrPedido11;
    ...
    private javax.swing.JLabel lbNrPedido6;
    private javax.swing.JLabel lbNrPedido7;
    private javax.swing.JLabel lbNrPedido8;
    private javax.swing.JLabel lbNrPedido9;

...
import Tela.JTableMap.PedidoCustomJtable;
...
public class RealizarPagamento extends javax.swing.JFrame {
    ...
    public void carregaDetalhesTela() {
        ...
        btCarregarComanda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/carr.png")));
        ...
        btRealizarPagamento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/pag.png")));
        btAltPedido.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/alter.png")));
        btSelecAdicionais.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/more.png")));
        btCom.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        btCom20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/mesa.png")));
        this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/Icone/pay.png")).getImage());
    ...
    public void carregarTabelaPedido(int idComanda) {
        try {
            List<Pedido> pedidosNaoAtendidosEncontrados = PedidoDAO.getInstance().findAllAtender(1, idComanda);
            ...
            PedidoCustomJtable tm = new PedidoCustomJtable(listaTodosPedidos, 0);
            ...
            if (pedidosNaoAtendidosEncontrados.size() != 0) {
                Object[] botoes = {"Sim", "Não"};
                int resposta = JOptionPane.showOptionDialog(null,
                        "Existem pedidos não atendido nesta comanda. Deseja cancelá-los?",
                        "Pedidos não atendidos", // o título da janela
                        JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null,
                        botoes, botoes[0]);
                if (resposta == 0) {
                    for (Pedido pedidos : pedidosNaoAtendidosEncontrados) {
                        pedidos.setStpedido(4);
                        PedidoDAO.getInstance().merge(pedidos);
                    }
                }
            }
    ...
    private void btAltPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAltPedidoActionPerformed
        ...
        try {
            ...
            PedidoCustomJtable tm;
            tm = new PedidoCustomJtable(listaTodosPedidos, 0);
    ...
    private void carregaAdicionaisEmTela() throws SQLException {
        ...
        Pedido pedido = tm.get(linha);
        edAdicionaisSelecionados.setText(RegrasPagamento.getInstance().carregarAdicionaisPedidos(pedido));
    }

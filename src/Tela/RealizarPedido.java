...
import Tela.JTableMap.ProdutoCustomJtable;
...
public class RealizarPedido extends javax.swing.JFrame {
    ...
    private void carregaDetalhesTela() {
        ...
        btPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icone/carr.png")));
        ...
        this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/Icone/carrin.png")).getImage());
    ...
    public void carregarTabelaPedido() {
        ...
        try {
            ...
            if (edComanda.getText().equalsIgnoreCase("")) {
                PedidoCustomJtable tm = new PedidoCustomJtable(null, 0);
                ...
                PedidoCustomJtable tm = new PedidoCustomJtable(lista, 0);
                tbPedidos.setModel(tm);
            }
    ...
    public void carregaTabela(List<Produto> produtos) {
        try {
            ProdutoCustomJtable tm = new ProdutoCustomJtable(produtos);
    ...
    private void btAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAdicionarActionPerformed
        try {
            ...
            ProdutoCustomJtable tm = new ProdutoCustomJtable(null);
            String retorno = "";
    ...
    private void btRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btRemoverActionPerformed
        try {
            if (!edComanda.getText().equalsIgnoreCase("")) {
                PedidoCustomJtable tm = new PedidoCustomJtable(null, Integer.parseInt(edComanda.getText()));
    ...
    private void btLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btLimparActionPerformed
        try {
            if (!edComanda.getText().equalsIgnoreCase("")) {
                ...
                resposta = RegrasPedido.getInstance().verificarSalvarPedido(Integer.parseInt((edComanda.getText())));
                if (resposta == 0) {
                    limpa();
                }
            } else {
    ...
    private void btSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSairActionPerformed
        try {
            if (!edComanda.getText().equalsIgnoreCase("")) {
                int resposta = RegrasPedido.getInstance().verificarSalvarPedido(Integer.parseInt((edComanda.getText())));
                if (resposta == 0) {
                    dispose();
                }
            } else {
    ...
    private void btSelecAdicionaisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSelecAdicionaisActionPerformed
        try {
            if (!edComanda.getText().equalsIgnoreCase("")) {
                ...
                tm = new PedidoCustomJtable(null, Integer.parseInt(edComanda.getText()));

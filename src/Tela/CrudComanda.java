...
public class CrudComanda extends javax.swing.JFrame {
    ...
    public void carregaDetalhesTela() {
        ...
        this.setIconImage(new javax.swing.ImageIcon(getClass().getResource("/Icone/com.png")).getImage());
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        ...
        } else if ("".equalsIgnoreCase(RegrasGerenciamento.getInstance().alterarComanda(Integer.parseInt(edId.getText()), edObservacao.getText()))) {
            carregaTabela();

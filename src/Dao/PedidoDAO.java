...
public class PedidoDAO {
    ...
    public List<Pedido> findAll(int comanda) throws SQLException {
        ...
        stmt = Utilidades.getInstance().pegarConexaoBD().prepareStatement("SELECT ID FROM Pedido where COMANDA_ID = ?");
    ...
    public List<Pedido> findAllByPagamento(int pagamento) throws SQLException {
        ...
        PreparedStatement stmt = Utilidades.getInstance().pegarConexaoBD().prepareStatement("SELECT ID FROM Pedido where PAGAMENTO_ID = ?");
    ...
    public List<Pedido> findAllAtender(int stPedido, int comanda) throws SQLException {
        ...
        PreparedStatement stmt;
        stmt = Utilidades.getInstance().pegarConexaoBD().prepareStatement("SELECT ID FROM Pedido where STPEDIDO = ? AND COMANDA_ID = ?");
    ...
    public List<Pedido> findAllAtendimento(int stPedido, int comanda) throws SQLException {
        ...
        PreparedStatement stmt = Utilidades.getInstance().pegarConexaoBD().prepareStatement("SELECT ID FROM Pedido where STPEDIDO <> ? AND COMANDA_ID = ?");
        stmt.setInt(1, stPedido);
        stmt.setInt(2, comanda);
        ResultSet rs = stmt.executeQuery();
    ...
    public List<Pedido> findAtualizarPedido(int comanda) throws SQLException {
        ...
        PreparedStatement stmt = Utilidades.getInstance().pegarConexaoBD().prepareStatement("SELECT ID FROM Pedido where DTATUALIZACAO IS NULL AND COMANDA_ID = ?");
        stmt.setInt(1, comanda);
        ResultSet rs = stmt.executeQuery();
    ...
    public List<Pedido> findAllPedidos() throws SQLException {
        List<Pedido> prod = new ArrayList<Pedido>();
       PreparedStatement stmt = Utilidades.getInstance().pegarConexaoBD().prepareStatement("SELECT ID FROM Pedido where STPEDIDO = 1 GROUP BY COMANDA_ID ORDER BY  DTATUALIZACAO");
        ResultSet rs = stmt.executeQuery();
